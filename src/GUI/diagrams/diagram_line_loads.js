function linePlot_loads_Update() {
  let upTraces = [
    mod_autoOutput.res_P_consumers_1_.allPrev,
    mod_autoOutput.res_P_consumers_2_.allPrev,
    mod_autoOutput.res_P_consumers_3_.allPrev,
    mod_autoOutput.res_P_consumers_4_.allPrev,
    mod_autoOutput.res_P_consumers_5_.allPrev,
  ];
  ...
  Plotly.update("linePlot_loads", data_update, layout); //  Plotly.update('linePlot', updateData, layout, [0]); [0] the last array specifies the trace (indices) to be updatet
}

// initialize plot
var cb_linePlot_loads = function () {
  ...
  Plotly.newPlot("linePlot_loads", initData, layout, config);
};
...
function init_linePlot_loads() {
  if (
    ...
    document.addEventListener("DOMContentLoaded", cb_linePlot_loads);
  }
}
